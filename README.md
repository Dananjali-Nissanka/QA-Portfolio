# QA Portfolio – Dananjali Nissanka
...
- Login & Logout
- Dashboard
- Add and Delete Good Habits (CRUD operations)
- Contact Page
...
- Validation Testing (including email format validation)
- Basic Security Testing
- CRUD Operation Testing (Add/Delete Habits)
...
my QA skills as a recent graduate seeking opportunities in Software Quality
Assurance.
